...
public class RoadGenerator extends JPanel {
	...
	public boolean vehicleOffRoad(CarBot vehicle) {
		RoadSegment currentSegment = new RoadSegment(new Point(getWidth() * roadCenterHistory.get(0) / 100, getHeight()),
				new Point(getWidth() * roadCenterHistory.get(1) / 100, getHeight() - y_step), roadWidth, roadLineWidth);
		for (Point occupies : vehicle.getIcon().getOccupationPoints())
