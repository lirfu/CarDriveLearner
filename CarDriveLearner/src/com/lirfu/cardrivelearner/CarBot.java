...
import com.lirfu.cardrivelearner.learner.Action;

/**
 * The heart of the game. Calls the road generator and updates score. Takes the input movement and reacts.
 */
public class CarBot extends Canvas implements Action {
	...
	public void perform(Movement movement) {
		...
		if (screenPositionPercent > (100 * (1 - ((double) vehicle.getWidth()) / 2 / getWidth()))) {
			screenPositionPercent =
					(int) (100 * (1 - ((double) vehicle.getWidth()) / 2 / getWidth()));
